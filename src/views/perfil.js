...
class Perfil extends React.Component {
    ...
    load = () => {
        ...
        axios.get(`https://18.205.79.20:4040/user/about?id=${usuarioLogado.id}`)
            .then(response => {
    ...
    loadType = () => {
        ...
        axios.get('https://18.205.79.20:4040/conhecimentos/types')
            .then(response => {
                const data = response.data
    ...
    loadConhecimentos = () => {
        ...
        axios.get(`https://18.205.79.20:4040/conhecimentos/buscar/conhecimentos?id=${usuarioLogado.id}`)
            .then(response => {
                const data = response.data
    ...
    loadInteresses = () => {
        ...
        axios.get(`https://18.205.79.20:4040/conhecimentos/buscar/interesses?id=${usuarioLogado.id}`)
            .then(response => {
                const data = response.data
    ...
    atualizar = () => {
        ...
        axios.patch("https://18.205.79.20:4040/user/about", {
    ...
    addConhecimento = () => {
        ...
        axios.post('https://18.205.79.20:4040/conhecimentos/adicionar/conhecimento',
        {
        ...
        addInteresse = () => {
            ...
            axios.post('https://18.205.79.20:4040/conhecimentos/adicionar/interesse',
            {
     ...
     select = (value) =>{
           ...
           axios.get(`https://18.205.79.20:4040/conhecimentos/knowledges/${value}`)
                    .then(response => {
                        const data = response.data
    ...
    axios.delete(`https://18.205.79.20:4040/conhecimentos/remover/conhecimento/${this.state.to_delete}`)
    .then(response => {
    ...
    deletarInteresse = () => {
        axios.delete(`https://18.205.79.20:4040/conhecimentos/remover/interesse/${this.state.to_delete}`)
        .then(response => {
            console.log("Deletado com sucesso")
            window.location.reload();
        }).catch(erro => {
