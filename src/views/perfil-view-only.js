...
class PerfilViewOnly extends React.Component {
    ...
    load = () => {
        ...
        axios.get(`http://18.205.79.20:8080/user/view/${usuarioID}`)
            .then(response => {
    ...
    loadConhecimentos = (value) => {
        ...
        axios.get(`http://18.205.79.20:8080/conhecimentos/buscar/conhecimentos?id=${value}`)
            .then(response => {
                const data = response.data
    ...
    loadInteresses = (value) => {
        ...
        axios.get(`http://18.205.79.20:8080/conhecimentos/buscar/interesses?id=${value}`)
            .then(response => {
                const data = response.data
