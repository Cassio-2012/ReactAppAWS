...
class PerfilViewOnly extends React.Component {
    ...
    load = () => {
        ...
        axios.get(`https://18.205.79.20:4040/user/view/${usuarioID}`)
            .then(response => {
    ...
    loadConhecimentos = (value) => {
        ...
        axios.get(`https://18.205.79.20:4040/conhecimentos/buscar/conhecimentos?id=${value}`)
            .then(response => {
                const data = response.data
    ...
    loadInteresses = (value) => {
        ...
        axios.get(`https://18.205.79.20:4040/conhecimentos/buscar/interesses?id=${value}`)
            .then(response => {
                const data = response.data
